...
2. volatile原理？https://blog.csdn.net/qq_22162093/article/details/106444735，锁总线，缓存锁，总线嗅探，MESI，JMM
...
4. RR下的事务之间并发写是怎么解决冲突的？

5. MVCC解决什么问题的？快照读的问题https://www.zhihu.com/question/464248235

6. MVCC的优缺点？优点是读操作都有快照，不会出问题，不需要加锁；缺点是快照占空间。

7. MySQl的ACID是怎么实现的？https://www.cnblogs.com/rjzheng/p/10841031.html

8. MySQL的事务是怎么实现的？单机的？分布式的？https://blog.csdn.net/hxcaifly/article/details/84928735

9. MySQL锁有哪些，是什么实现逻辑？https://www.cnblogs.com/huangrenhui/p/12580966.html。锁这部分主要看自己写的xmind

10. 并发过程中如何保证我定义的变量不会被修改？对于修改，RR下加行锁，提交才释放；对于增删，RR下快照读MVCC，当前读间隙锁

11. 间隙锁是什么？什么是NextKey？什么时情况下加next key lock？RR及以上，当前读

12. 什么是意向锁？有什么作用？

13. 三种Log文件里面都存了什么？有什么作用？

14. B+树的结构特点？

15. B+树一个节点多大？是怎么确定的？和磁盘结构什么关系？和操作系统有什么关系？

16. 为什么索引用B+树，不用B树或者AVL树/红黑树？https://www.cnblogs.com/leijiangtao/p/4662779.html

17. 为什么B+树比B树高度低，以及其他方面的比较？https://zhuanlan.zhihu.com/p/27700617

18. 千万级数据B+树大概有多高？https://blog.csdn.net/dl674756321/article/details/102987984

19. MySQL中有哪些索引类型？（多叉树，非叶子结点不存数据，叶子结点用[链表](https://www.nowcoder.com/jump/super-jump/word?word=链表)串起来，针对访问较多的结点InnoDB还支持自适应哈希；低树高，支持范围查找）

20. 什么是联合索引？

21. 索引和主键的区别？

22. 聚簇索引？非聚簇索引？主键索引？唯一索引？区别？

23. 联合索引，AB，只有一个B会生效吗？不会生效

24. InnoDB的LRU List？

25. 主键和外键和索引的区别？联表怎么建索引？https://blog.csdn.net/yangfengjueqi/article/details/78491090

26. 创建索引基本的指令有了解吗？alter table add key。会锁表

27. 什么时候加索引？加哪种索引？https://blog.csdn.net/kaka1121/article/details/53395628

28. mysql驱动引擎 innodb和myisam的区别

29. MySQL慢查询如何排查？如何优化？可能的原因：1. 机器性能低 2. 有别的大事务在执行并且里面加锁了阻塞了当前SQL 3. where中的条件不对 4. 查询条件没优化导致没走索引

30. MySQL一致性哈希，水平分表？https://blog.csdn.net/Daybreak1209/article/details/80257508

31. MySQL主从架构是怎么做数据同步的？https://www.cnblogs.com/fengdejiyixx/p/11185019.html

32. MySQL主从延迟是怎么回事？https://mp.weixin.qq.com/s/lR7uUfLfPlMS5qP6m84KTQ

33. 跨库事务如何保证？2PC。https://www.cnblogs.com/isuben/p/7908468.html，https://blog.csdn.net/weixin_35979889/article/details/112639901
