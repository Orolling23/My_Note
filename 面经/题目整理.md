...
21. [redis](https://www.nowcoder.com/jump/super-jump/word?word=redis)的setnx有什么问题，怎么解决超时释放，锁的时间小于业务执行时间，该怎么处理？
22. Redis中超时的键是怎么被清理的？
23. Redis为什么快？（内存操作、单线程不需要锁）
24. 为什么设计成单线程？
25. 关系型和非关系型数据库的区别？https://www.zhihu.com/question/24225007
26. [redis](https://www.nowcoder.com/jump/super-jump/word?word=redis)内存回收，过期策略和淘汰机制？看笔记
27. Redis的缓存淘汰有哪些算法？6种，lru，lfu，random，随机，禁止驱逐（默认），淘汰将要过期的
28. LRU是怎么实现的？Redis里面是怎么实现的？https://zhuanlan.zhihu.com/p/34133067
29. 如果让你实现LRU，你会怎么实现？能不能达到O(1)？
30. 哨兵？解决什么问题？怎么实现的？https://zhuanlan.zhihu.com/p/187489414
31. 讲讲哨兵Sentinel领导者选举用的什么算法？Raft
